...
Паналель администратора доступна по адресу http://158.160.31.83/admin/<br>
Возможно для user указать роль admin. По умолчанию все юзеры создаются с правами user.
